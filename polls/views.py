    ...
    def handle(self, *args, **options):
        ...
        if Question.objects.count() == 0:
            ...
            q3 = Question.objects.create(
                question_text="What's your preferred operating system?",
                pub_date=timezone.now()
            )
            Choice.objects.create(question=q3, choice_text="Windows", votes=0)
            Choice.objects.create(question=q3, choice_text="macOS", votes=0)
            Choice.objects.create(question=q3, choice_text="Linux", votes=0)
            Choice.objects.create(question=q3, choice_text="Other", votes=0)
